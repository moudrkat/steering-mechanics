...
| F5 | **Emergent-misalignment false positives** — steering flagged +0.3 harmful compliance on 2/2 models via TWO different metric bugs (vocabulary drift; thinking-model truncation); model refused throughout | "TWO false positives, two metric failures"; clean re-runs: qwen3-4b +0.0 AND qwen3-8b +0.0 (/no_think, 2026-07-25) — both artifacts fully closed | ✅ solid & CLOSED |
